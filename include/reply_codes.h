...
#define FTP_REPLY_226 "226 Closing data connection. Requested file action successful.\r\n"
...
#define FTP_REPLY_421 "421 Service not available, closing control connection.\r\n"
...
#define FTP_REPLY_452 "452 Requested action not taken. Insufficient storage space in system.\r\n"
...
#define FTP_REPLY_550 "550 Requested action not taken. File unavailable (e.g., file not found, no access).\r\n"
#define FTP_REPLY_551 "551 Requested action aborted: page type unknown.\r\n"
#define FTP_REPLY_552 "552 Requested file action aborted. Exceeded storage allocation (for current directory or dataset).\r\n"
